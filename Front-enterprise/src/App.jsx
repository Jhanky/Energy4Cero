...
import { VistaResumen, VistaProyectos, VistaAnalisis, VistaAire, DetalleProyecto } from './pages/proyectos';
...
import UsuariosPage from './pages/administrativa/UsuariosPage';
import RolesPage from './pages/administrativa/RolesPage';
...
import SuministrosPage from './pages/comercial/SuministrosPage';
        ...
        <Routes>
          ...
          <Route path="/" element={<Layout />}>
            ...
            <Route
              ...
              element={
                <ProtectedRoute permission="projects.read">
                  <DetalleProyecto estados={estados} />
                </ProtectedRoute>
              }
            />
            <Route
