...
import { X, Save, Plus, Shield, AlertTriangle, Check, Minus } from 'lucide-react';

const SimplifiedRoleForm = ({ 
  isOpen, 
  ...
  const handleNameChange = (e) => {
    ...
    const slug = mode === 'create' && !formData.slug ? generateSlug(name) : formData.slug;
              ...
              {!isViewMode && (
                <div className="flex items-center gap-3 mb-4">
                  <button
                    ...
                    className="flex items-center gap-2 px-3 py-1.5 text-sm text-slate-600 border border-slate-300 rounded-lg hover:bg-slate-50 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                  >
...
export default SimplifiedRoleForm;