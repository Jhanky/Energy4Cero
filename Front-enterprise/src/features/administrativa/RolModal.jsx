        ...
        <div className="p-6">
          ...
          <form onSubmit={onSubmit} className="space-y-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                ...
                <input
                  ...
                  disabled={mode === 'view'}
                  className={`w-full px-4 py-3 border rounded-xl focus:ring-2 focus:ring-ring focus:border-ring ${formErrors.name ? 'border-red-300 bg-red-50' : 'border-input'
                    }`}
              ...
              <div>
                ...
                <input
                  ...
                  disabled={mode === 'view'}
                  className={`w-full px-4 py-3 border rounded-xl focus:ring-2 focus:ring-ring focus:border-ring ${formErrors.slug ? 'border-red-300 bg-red-50' : 'border-input'
                    }`}
              ...
              <div className="md:col-span-2">
                ...
                <textarea
                  ...
                  disabled={mode === 'view'}
                  rows={3}
                  className="w-full px-4 py-3 border border-input rounded-xl focus:ring-2 focus:ring-ring focus:border-ring"
            ...
            <div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 max-h-64 overflow-y-auto border border-border rounded-xl p-4">
