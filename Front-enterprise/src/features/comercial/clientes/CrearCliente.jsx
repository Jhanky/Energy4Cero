...
const CrearCliente = ({ onClose, onSuccess }) => {
        ...
        <form onSubmit={handleSubmit} className="p-6">
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <input
                  ...
                  className={`w-full px-3 py-2 border rounded-lg focus:ring-2 focus:ring-ring focus:border-ring ${formErrors.name ? 'border-destructive' : 'border-input'
                    }`}
                  required
                />
                {formErrors.name && (
                  <p className="text-destructive text-sm mt-1">{formErrors.name[0]}</p>
                )}
              </div>
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <input
                  ...
                  className={`w-full px-3 py-2 border rounded-lg focus:ring-2 focus:ring-ring focus:border-ring ${formErrors.email ? 'border-destructive' : 'border-input'
                    }`}
                />
                {formErrors.email && (
                  <p className="text-destructive text-sm mt-1">{formErrors.email[0]}</p>
                )}
              </div>
          ...
          <div className="flex justify-end gap-3 mt-6 pt-6 border-t border-border">
            <button
              type="button"
              onClick={onClose}
              className="px-4 py-2 text-slate-600 border border-input rounded-lg hover:bg-muted/50 transition-colors"
            >
              Cancelar
            </button>
            <button
