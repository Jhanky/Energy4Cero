...
import { Calculator, DollarSign, Receipt, Truck, Building2, BarChart3, TrendingUp, TrendingDown, ArrowUpRight, MoreHorizontal, PieChart } from 'lucide-react';
...
const HomeContable = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-purple-50 to-indigo-50 p-6">
      <div className="relative overflow-hidden rounded-2xl bg-gradient-to-r from-purple-600 via-indigo-600 to-blue-700 p-8 mb-8 text-white shadow-2xl">
        ...
        <div className="relative z-10 flex items-center justify-between">
          <div className="flex items-center gap-6">
            ...
            <div>
              <h1 className="text-3xl md:text-4xl font-bold mb-2">Centro Financiero Digital</h1>
              <p className="text-purple-100 text-lg">Gestión Contable Integral - Enterprise Financial Hub</p>
              <div className="flex items-center gap-2 mt-3">
                <div className="w-2 h-2 bg-green-400 rounded-full animate-pulse"></div>
                <span className="text-sm text-purple-200">Finanzas saludables - Balance positivo</span>
              </div>
            </div>
          </div>
          <div className="hidden md:block">
            <div className="text-right">
              <p className="text-purple-200 text-sm">Estado financiero</p>
              <p className="text-white font-semibold">Excelente</p>
            </div>
          </div>
        </div>
      </div>
                ...
                {quickActions.map((action) => {
                  ...
                  return (
                    <div key={action.id} className="group relative overflow-hidden bg-gradient-to-r from-white to-slate-50 border border-slate-200 rounded-xl p-6 hover:shadow-lg transition-all duration-300 hover:scale-105 cursor-pointer">
                      <div className="absolute inset-0 bg-gradient-to-r opacity-0 group-hover:opacity-10 transition-opacity duration-300 from-purple-500 to-indigo-500"></div>
                      <div className="relative z-10">
                        ...
                        <h3 className="font-semibold text-slate-900 group-hover:text-purple-700 transition-colors">{action.nombre}</h3>
              ...
              <div className="space-y-4">
                <div className="flex items-start gap-3 p-3 bg-gradient-to-r from-green-50 to-emerald-50 rounded-lg border border-green-100">
                  ...
                  <div className="flex-1 min-w-0">
                    <p className="text-sm font-medium text-slate-900">Nuevo indicador KPI alcanzado</p>
                    <p className="text-xs text-slate-600">ROI del 15% - Meta superada - Hace 30 minutos</p>
                  </div>
                </div>
                <div className="flex items-start gap-3 p-3 bg-gradient-to-r from-blue-50 to-indigo-50 rounded-lg border border-blue-100">
                  ...
                  <div className="flex-1 min-w-0">
                    <p className="text-sm font-medium text-slate-900">Factura de proveedor procesada</p>
                    <p className="text-xs text-slate-600">$12,500 - Energía Solar Corp - Hace 1 hora</p>
                  </div>
                </div>
                <div className="flex items-start gap-3 p-3 bg-gradient-to-r from-purple-50 to-violet-50 rounded-lg border border-purple-100">
                  ...
                  <div className="flex-1 min-w-0">
                    <p className="text-sm font-medium text-slate-900">Nuevo centro de costos creado</p>
                    <p className="text-xs text-slate-600">División de Operaciones - Hace 3 horas</p>
                  </div>
                </div>
              </div>
            </CardContent>
