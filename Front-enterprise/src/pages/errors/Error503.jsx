...
const Error503 = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-yellow-50 to-slate-100 flex items-center justify-center px-4">
      <div className="max-w-md w-full text-center">
        ...
        <div className="mb-8">
          ...
          <h1 className="text-6xl font-bold text-gray-900 mb-2">503</h1>
          <h2 className="text-2xl font-semibold text-gray-700 mb-4">Servicio no disponible</h2>
