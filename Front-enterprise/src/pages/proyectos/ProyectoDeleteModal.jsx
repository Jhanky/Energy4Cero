import { AlertTriangle, X, FolderOpen, User, Calendar, DollarSign, Loader2 } from 'lucide-react';
          ...
          >
            ...
            >
              <div className="flex items-start gap-4">
                ...
                <motion.button
                  onClick={onCancel}
                  disabled={isDeleting}
                  className="flex-shrink-0 p-1 text-slate-400 hover:text-slate-600 dark:text-slate-500 dark:hover:text-slate-300 rounded-lg hover:bg-slate-100 dark:hover:bg-slate-700 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
            ...
            >
              ...
              >
                ...
                <span className="font-semibold text-slate-900 dark:text-slate-100">{proyecto.name}</span>?
              </motion.p>
              ...
              >
                <div className="space-y-3">
                  ...
                  >
                    ...
                    <div>
                      <p className="font-medium text-slate-900 dark:text-slate-100">{proyecto.name}</p>
                      <p className="text-sm text-slate-600 dark:text-slate-400">{proyecto.description}</p>
                    </div>
                  </motion.div>
            ...
            >
              ...
              <motion.button
                onClick={onConfirm}
                disabled={isDeleting}
                className="px-6 py-2 bg-red-600 hover:bg-red-700 text-white rounded-lg transition-colors disabled:opacity-50 disabled:cursor-not-allowed flex items-center gap-2 min-w-[150px] justify-center"
                variants={buttonVariants}
                initial="idle"
                whileHover={!isDeleting ? "hover" : "idle"}
                whileTap={!isDeleting ? "tap" : "idle"}
